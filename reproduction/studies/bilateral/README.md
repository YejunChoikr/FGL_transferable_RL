...
Runs generate learning curves, selected designs and policy checkpoints under
`generated/`. The selected-design responses generated by these commands are
surrogate predictions; the commands do not invoke Ansys.

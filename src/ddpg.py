"""Deep deterministic policy gradient, implemented directly in PyTorch.

  actor  : state -> 4096 -> 2048 -> 1024 -> 512 -> 1, ReLU hidden, tanh output
  critic : (state, action) -> 4096 -> 2048 -> 1024 -> 512 -> 1, linear output

A single critic, a target actor and a target critic, and Ornstein-Uhlenbeck
exploration noise reset at the start of every episode.
"""
